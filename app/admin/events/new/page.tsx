...
const handleSubmit = async (publish: boolean) => {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl px-4 sm:px-0">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">New event</h1>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 flex flex-col gap-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-500 mb-1">Time (GMT) *</label>
              <input
                type="time"
                name="time"
                value={form.time}
        ...
        <div className="border-t border-gray-100 pt-5">
          ...
          <div className="space-y-3">
            {heroPreview && (
              <div className="relative w-full sm:w-48 h-48 sm:h-32 rounded-lg overflow-hidden">
            ...
            />
            <p className="text-xs text-gray-400">Main image shown on event cards and hero sections</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-5">
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm"
            />
            <p className="text-xs text-gray-400">Secondary image for about sections</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <button
              type="button"
              onClick={addPlan}
              className="text-xs bg-blue-50 text-blue-600 px-3 py-1.5 sm:py-1 rounded-full hover:bg-blue-100 transition w-full sm:w-auto"
            >
              + Add Plan
            </button>
          </div>
              ...
              <div key={index} className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-end">
                ...
                {form.ticketPlans.length > 1 && (
                  <button
                    ...
                    className="text-red-500 hover:text-red-700 text-sm px-2 py-2 sm:py-0 self-end sm:self-center mb-0.5"
                  >
                    ✕
                  </button>
                )}
        ...
        {/* Actions */}
        <div className="border-t border-gray-100 pt-5 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3">
          <button
            onClick={() => router.back()}
            className="text-sm text-gray-500 hover:text-gray-700 px-4 py-2 w-full sm:w-auto"
          >
            Cancel
          </button>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <button
              ...
              disabled={loading}
              className="border border-gray-300 text-gray-700 text-sm font-medium px-5 py-2 rounded-lg hover:bg-gray-50 transition disabled:opacity-50 w-full sm:w-auto"
            >
              Save draft
            </button>
            <button
              ...
              disabled={loading}
              className="bg-[#0f172a] text-white text-sm font-semibold px-5 py-2 rounded-lg hover:bg-[#1e293b] transition disabled:opacity-50 w-full sm:w-auto"
            >
